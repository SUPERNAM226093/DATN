                                ...
                                >
                                    <div className="w-14 h-14 rounded-2xl bg-[#E6EFFF] flex items-center justify-center mx-auto mb-3 group-hover:bg-[#0065FF] transition-colors">
                                        {spec.featureImageUrl ? (
                                            <img src={`https://sandy-marker-trance-column.trycloudflare.com${spec.featureImageUrl}`} alt={spec.name} className="w-8 h-8 object-contain group-hover:brightness-[100] group-hover:invert" />
                                        ) : (
