...
const API_BASE_URL = isServer
    ? (process.env.INTERNAL_API_URL || process.env.NEXT_PUBLIC_API_URL || "https://scholars-foot-burner-pose.trycloudflare.com")
    : (process.env.NEXT_PUBLIC_API_URL || "https://scholars-foot-burner-pose.trycloudflare.com");
