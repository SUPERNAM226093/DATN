...
>
> - `NEXT_PUBLIC_API_URL=https://outline-puzzle-york-maple.trycloudflare.com`
>
...
Nguyên nhân rất hay gặp là `NEXT_PUBLIC_API_URL` vẫn để `https://outline-puzzle-york-maple.trycloudflare.com` trong compose.
